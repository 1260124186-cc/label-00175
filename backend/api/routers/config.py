...
async def get_saved_config(filename: str):
    data = load_saved_config(filename)
...
async def save_config(req: SaveConfigRequest):
    ...
    saved_path = save_config_to_file(config_dict, req.filename)
...
async def remove_config(filename: str):
    delete_saved_config(filename)
